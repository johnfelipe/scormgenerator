                    ...
                    <Card.Body className="p-2">
                        ...
                        <Tabs defaultActiveKey="answers" id="question-answers-files-tabs">
                            ...
                            <Tab eventKey="explanation" title="Explanation">
                                {
                                    ...
                                    :
                                        <div className="drag-drop-explanation-action-button mt-2 mb-2">
                                            <button
                                                type="button"
                            ...
                            <Tab eventKey="files" title="Files">
                                <div className="drag-drop-question-action-button mt-2">
                                    ...
                                    <Droppable droppableId="files-droppable">
                                        {(provided) => (
                                            ...
                                            >
                                                {
                                                    item.files.length > 0 ?
                                                        <ul className="drag-drop-question-files-list list-unstyled">
                                                            {item.files.map((file, fileIndex) => (
                                                                <Draggable
                                                                    key={'drag-drop-question-files-list-item-key-' + fileIndex}
                                                                    draggableId={'drag-drop-question-files-list-item-' + fileIndex}
                                                                    index={fileIndex}
                                                                >
                                                                    {(provided) => (
                                                                        <li
                                                                            className="drag-drop-question-files-list-item mt-2"
                                                                            ref={provided.innerRef}
                                                                            {...provided.draggableProps}
                                                                            {...provided.dragHandleProps}
                                                                        >
                                                                            <div id="drag-drop-question-file-item" className="row mb-0 border rounded-top" onClick={() => accordionClick(collapseAccordion, file)}>
                                                                                ...
                                                                                <div
                                                                                    className="col-md-1 p-0 drag-drop-question-file-item-delete"
                                                                            ...
                                                                            {file.label === "" ?
                                                                                <>
                                                                                    {imgAddLabel && file.img ?
                                                                                        <div className={imgCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                    ...
                                                                                    :
                                                                                        file.label === "" && file.img &&<div className={imgCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                    ...
                                                                                    {audioAddLabel && file.audio ?
                                                                                        <div className={audioCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                            <div className="img-add-label-wrapper text-center">
                                                                                            <div className="img-add-label-label d-inline mr-2">
                                                                                                <span>Label:</span>
                                                                                            </div>
                                                                                    ...
                                                                                    :
                                                                                        file.label === "" && file.audio &&<div className={audioCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                    ...
                                                                                    {videoAddLabel && file.video ?
                                                                                        <div className={videoCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                            <div className="img-add-label-wrapper text-center">
                                                                                            <div className="img-add-label-label d-inline mr-2">
                                                                                                <span>Label:</span>
                                                                                            </div>
                                                                            ...
                                                                            {file.video && file.video.caption &&
                                                                                <ul className={collapseAccordion ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                    <li className="drag-drop-question-file-item-list-item">
                                                                            ...
                                                                            {file.label &&
                                                                                <>
                                                                                    ...
                                                                                    <ul className={imgCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                        <li className="drag-drop-question-file-item-list-item">
                                                                                            <div className="row m-0">
                                                                                    ...
                                                                                    <ul className={audioCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                        <li className="drag-drop-question-file-item-list-item">
                                                                                            <div className="row m-0">
                                                                                                <div className="col-md-8">{file.label}</div>
                                                                                                <div
                                                                                    ...
                                                                                    <ul className={videoCollapse ? "sg-accordion drag-drop-question-action-button border border-top-0 py-2 px-1" : "d-none drag-drop-question-action-button border py-2 px-1"}>
                                                                                        <li className="drag-drop-question-file-item-list-item">
                                                                                            <div className="row m-0">
                                                                                                <div className="col-md-8">{file.label}</div>
                                                                                                <div
