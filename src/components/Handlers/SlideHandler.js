...
class SlideHandler extends Component {
            ...
            for (var key in currentColumns) {
                if (destination.droppableId === currentColumns[key]['id']) {
                    ...
                    if (currentFeatures[source.index]['type'] === 'contentArea') {
                        ...
                        let currentContent = { type: currentFeatures[source.index]['type'], output: { courseInfo: { name: 'Course Information', content: 'No information provided yet.'}, courseReq:  { name: 'Course Requirements', content: 'No requirements provided yet.'}, introVideo: 'https://file-examples-com.github.io/uploads/2017/04/file_example_MP4_480_1_5MG.mp4' }, class: '', id: '', styles: { courseIntroColor: '#0069d9' } };
                        currentColumns[key].content.subColumnOne.push(currentContent);
                        this.setState({
                            column: currentColumns,
                            activeFeature: currentFeatures[source.index]['type'],
    ...
    resetFeature = (contentIndex, featureType) => {
        ...
        if (featureType === "audio") {
            ...
            currentColumnObj.content[currentColumnContentIndex][contentIndex] = { type: 'courseObjectives', output: { courseInfo: { name: 'Course Information', content: 'No information provided yet.'}, courseReq:  { name: 'Course Requirements', content: 'No requirements provided yet.'}, introVideo: 'https://file-examples-com.github.io/uploads/2017/04/file_example_MP4_480_1_5MG.mp4' }, class: '', id: '', styles: { courseIntroColor: '#0069d9' } };
        }
